...
public class OhmageLoginActivity extends FragmentActivity {

	public static final String TAG = "LoginActivity";

	/**
	 * The {@link OhmageLoginActivity} looks for this extra to determine if
	...
	private void doLogin() {
		...
		new LoginTask(OhmageLoginActivity.this).execute(username, password);
	}
	...
	private static class LoginTask extends ManagedAsyncTask<String, Void, OhmageApi.AuthenticateResponse>{
		...
		protected OhmageApi.AuthenticateResponse doInBackground(String... params) {
			...
			return api.authenticate("https://dev.mobilizingcs.org/", mUsername, mPassword, OhmageApi.CLIENT_NAME);
		}
		...
		protected void onPostExecute(OhmageApi.AuthenticateResponse response) {
			...
			((OhmageLoginActivity) getActivity()).onLoginTaskDone(response, mUsername);
		}
	}
}
